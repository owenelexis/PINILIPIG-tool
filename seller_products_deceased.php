...
<head>
   ...
   <title>PINILI-PIG: Deceased</title>
...
<body>
   ...
   <section class="show-products">
      ...
      <div class="box-container">
         ...
         <?php
         $select_pigs = mysqli_query($conn, "SELECT * FROM `pig` LEFT JOIN `cycle` ON pig.cycle=cycle.id WHERE owner='$seller_id' AND pig_status = 'deceased'") or die('query failed');
