...
<head>
   ...
   <title>PINILI-PIG: Admin-Sellers</title>
...
<section class="users">
   ...
   <h1 class="title">sellers account</h1>

   <div class="box-container">
      <?php
         $select_users = mysqli_query($conn, "SELECT * FROM `seller`") or die('query failed');
         if(mysqli_num_rows($select_users) > 0){
            while($fetch_users = mysqli_fetch_assoc($select_users)){
      ?>
      <div class="box">
         <p>userID : <span><?php echo $fetch_users['sellerID']; ?></span></p>
         <p>firstname : <span><?php echo $fetch_users['firstname']; ?></span></p>
         <p>lastname : <span><?php echo $fetch_users['lastname']; ?></span></p>
         <p>farmname : <span><?php echo $fetch_users['farmname']; ?></span></p>
         ...
         <a href="admin_users.php?delete=<?php echo $fetch_users['sellerID']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">delete</a>
      </div>
      <?php
         }
      }
