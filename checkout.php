...
if (isset($_POST['order'])) {
    ...
    if (mysqli_num_rows($cart_query) > 0) {
        while ($cart_item = mysqli_fetch_assoc($cart_query)) {
            ...
            if ($d_method == 'deliver to address') {
                $price = $price + 100;  
            }

            $query = "INSERT INTO `transaction` (buyer, seller, delivery_address, pigs, total_amount, status, delivery_method, payment_method, additional) 
                      VALUES ('$user_id', '$sellerID', '$full_address', '$pigID', '$price', 'Pending', '$d_method', '$p_method', '$additional')";
            ...
            <div class="flex">
                <div class="inputBox">
                    ...
                    <select name="delivery_method">
                        ...
                        <option value="deliver to address">deliver to address (₱100 fee/pig)</option>
                    </select>
                </div>
                <div class="inputBox">
