...
<head>
   ...
   <title>PINILI-PIG: Fatterner</title>
...
<body>
   ...
   <section class="show-products">
      ...
      <div class="box-container">
         ...
         <?php
         $select_pigs = mysqli_query($conn, "SELECT * FROM `pig` LEFT JOIN `cycle` ON pig.cycle=cycle.id WHERE owner='$seller_id' AND category = 'Fattener'") or die('query failed');
