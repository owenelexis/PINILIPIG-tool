...
<head>
   ...
   <title>PINILI-PIG: Delivered</title>
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      $select_transaction = mysqli_query($conn, "SELECT * FROM transaction T JOIN user U ON T.buyer=U.userID WHERE T.seller = '$seller_id' and T.status = 'Delivered'") or die('query failed');
      ...
      <div class="box">
         ...
         <p> Date Delivered : <span><?php echo $fetch_transaction['date_updated']; ?></span> </p>
